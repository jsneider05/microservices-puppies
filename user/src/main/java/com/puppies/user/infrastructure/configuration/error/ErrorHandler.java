package com.puppies.user.infrastructure.configuration.error;

import com.puppies.user.domain.exception.ExternalApiException;
import com.puppies.user.domain.exception.InternalProcessException;
import com.puppies.user.domain.exception.InvalidValueException;
import com.puppies.user.domain.exception.NoDataException;
import com.puppies.user.domain.exception.RequiredValueException;
